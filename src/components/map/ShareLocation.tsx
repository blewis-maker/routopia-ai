...
export const ShareLocation = ({ position, address }: ShareLocationProps) => {
  ...
  const shareUrl = `https://www.google.com/maps/search/?api=1&query=${position.lat},${position.lng}`;
  ...
  return (
    <div className="relative">
      ...
      {showShareMenu && (
        <div className="absolute bottom-full mb-2 right-0 bg-white rounded-lg shadow-lg p-4 min-w-[200px]">
          <div className="flex flex-col space-y-2">
            ...
            <a
              href={`https://wa.me/?text=${encodeURIComponent(`My current location: ${address}\n${shareUrl}`)}`}
              target="_blank"
